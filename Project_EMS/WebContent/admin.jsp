...
<div class="header">
    ...
    <div id="site_title"><a href="admin.jsp"><img src="img/Logo Marlabs_0.png" width= "188" height="95" /></a>

    <!-- Main Menu -->
    
    <ol id="menu">
             <li><a href="admin.jsp" style="background-color:#DCE1F5" >Home</a>
